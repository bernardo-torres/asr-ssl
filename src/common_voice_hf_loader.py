...
def iter_archive(path):
        ...
        """
        print("Extracting archive at " + str(path))
        extracted_path = path
        ...
        for root, dirs, files in os.walk(extracted_path, topdown=True):
            ...
            for name in files:
                ...
                #print(relative_file_path, absolute_file_path)
                with open(absolute_file_path, "rb") as file_obj:
                    yield (absolute_file_path, file_obj)
...
_DATA_URL = '/content/cache/downloads/extracted/2aa78e8497f26e856bb1297e802b5e7d3bc2800c5d11d5ab36c63bb76e643316/cv-corpus-6.1-2020-12-11'
_CITATION = """\
...
class CommonVoice(datasets.GeneratorBasedBuilder):
    ...
    def _info(self):
        ...
        return datasets.DatasetInfo(
            ...
            license=_LICENSE,
            citation=_CITATION,
            task_templates=[AutomaticSpeechRecognition(audio_file_path_column="audio", transcription_column="sentence")],
        )
        ...
        for path, f in archive_iterator:
            ...
            if path == metadata_filepath:
                ...
                for line in lines[1:]:
                    ...
                    if field_values[0].endswith('.mp3'):
